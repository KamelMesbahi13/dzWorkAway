          ...
          >
            {data.map(({ id, Img, Heading, Description }) => {
              return (
                <div key={id}>
                  <div>
                    <div className="p-4 duration-300 ease-in bg-opacity-0 shadow-xl lg:h-[28rem] xl:h-[22rem] hover:text-white bg-mainColor hover:bg-opacity-100 hover:border-opacity-100 lg:p-8">
